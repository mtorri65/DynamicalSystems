...
# calculate potential energy
		...
		V_single_particle[0] = 1/2 * k * x1_0**2
...
# calculate equations_of_motion
		...
		coeffs[0] = sympy.collect(LE_expand[0], [sympy.Derivative(degrees_of_freedom[0], (t, 2))], evaluate=False)
		Mat[0,1] = -coeffs[0][1]
